...
INTERNAL Template_Array_Data_Type * front(Template_Array_Name array, Template_Array_Size_Type offset = 0);
...
INTERNAL bool is_empty(Template_Array_Name array) {
    return !array.count;
}

INTERNAL Template_Array_Size_Type remaining_count(Template_Array_Name array) {
    return array.capacity - array.count;
}

INTERNAL bool is_full(Template_Array_Name array) {
    return !remaining_count(array);
}

INTERNAL usize count_in_bytes(Template_Array_Name array) {
    return sizeof(Template_Array_Data_Type) * array.count;
}

INTERNAL usize capacity_in_bytes(Template_Array_Name array) {
    return sizeof(Template_Array_Data_Type) * array.capacity;
}

INTERNAL Template_Array_Data_Type * first(Template_Array_Name array) {
    return array.data + array.head;
}

INTERNAL Template_Array_Data_Type * __x(Template_Array_Name array, Template_Array_Size_Type index) {
...
INTERNAL Template_Array_Data_Type * one_past_last(Template_Array_Name array) {
    return __x(array, array.count);
}

INTERNAL Template_Array_Data_Type * front(Template_Array_Name array, Template_Array_Size_Type plus_offset)
{
    assert(plus_offset < array.count);
    return __x(array, plus_offset);
}

INTERNAL Template_Array_Data_Type * front_or_null(Template_Array_Name array, Template_Array_Size_Type plus_offset = 0)
{
...
INTERNAL Template_Array_Data_Type * back(Template_Array_Name array, Template_Array_Size_Type minus_offset = 0)
{
    assert(minus_offset < array.count);
    return __x(array, array.count - 1 - minus_offset)
}

INTERNAL Template_Array_Data_Type * back_or_null(Template_Array_Name array, Template_Array_Size_Type minus_offset = 0)
{
...
INTERNAL Template_Array_Size_Type index(Template_Array_Name array, Template_Array_Data_Type *item)
{
    if (item >= front(array)) {
...
INTERNAL bool are_equal(Template_Array_Name a, Template_Array_Data_Type *b_data, Template_Array_Size_Type b_count) {
    if (a.count != b_count)
        return false;
...
INTERNAL bool operator==(Template_Array_Name a, Template_Array_Name b) {
    if (a.count != b.count)
        return false;
...
INTERNAL Template_Array_Name sub(Template_Array_Name array, Template_Array_Size_Type offset, Template_Array_Size_Type count_or_max = Array_Max_Index, bool offset_from_back = false)
{
...
INTERNAL void copy(Template_Array_Name *destination, Template_Array_Data_Type *data, Template_Array_Size_Type count)
{
    assert(count <= destination->count);
    COPY(destination->data, data, count_in_bytes(*destination));
}

INTERNAL void copy(Template_Array_Name *destination, Template_Array_Name source) {
    copy(destination, source.data, source.count);
}

INTERNAL void reset(Template_Array_Name array, Template_Array_Data_Type value) {
...
INTERNAL void clear(Template_Array_Name *array) {
    array->count = 0;
}
...
INTERNAL void advance(Template_Array_Name *iterator, Template_Array_Size_Type count = 1) {
...
INTERNAL Template_Array_Data_Type * push(Template_Array_Name *array, Template_Array_Data_Type *data_or_null, Template_Array_Size_Type count, Memory_Allocator *allocator = null)
{
...
INTERNAL Template_Array_Data_Type * push(Template_Array_Name *array, Template_Array_Data_Type value, Memory_Allocator *allocator = null)
{
    return push(array, &value, 1, allocator);
}

INTERNAL Template_Array_Data_Type * ordered_insert(Template_Array_Name *array, Template_Array_Data_Type *data_or_null, Template_Array_Size_Type count = 1, Template_Array_Size_Type offset_or_max = Array_Max_Index, Memory_Allocator *allocator = null)
{
...
INTERNAL Template_Array_Data_Type * ordered_insert(Template_Array_Name *array, Template_Array_Data_Type value, Template_Array_Size_Type offset_or_max = Array_Max_Index, Memory_Allocator *allocator = null)
{
    return ordered_insert(array, &value, 1, offset_or_max, allocator);
}

INTERNAL void pop(Template_Array_Name *array, Template_Array_Size_Type count = 1, Memory_Allocator *allocator = null)
{
...
INTERNAL void unordered_remove(Template_Array_Name *array, Template_Array_Size_Type offset_or_max = Array_Max_Index, Template_Array_Size_Type count = 1, Memory_Allocator *allocator = null)
{
    if (offset_or_max == Array_Max_Index) {
        assert(count <= array->count);
...
INTERNAL void ordered_remove(Template_Array_Name *array, Template_Array_Size_Type offset_or_max = -1, Template_Array_Size_Type count = 1, Memory_Allocator *allocator = null)
{
    if (offset_or_max == Array_Max_Index) {
        assert(count <= array->count);
        offset_or_max = array->count - count;
